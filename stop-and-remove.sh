...
case ${answer:0:1} in
    y|Y )
        ...
        echo "INFO: Removing directories and contents (certs/ certs-data/ logs/nginx/ mysql/ wp_thilak/ wp_sanne/)"
        rm -rf certs/ certs-data/ logs/nginx/ mysql/ wp_thilak/ wp_sanne/
        echo "INFO: Done"
        exit 0;
    ;;
    * )
